...
public:
	...
	double focus_dist{ 10 };	// Distance of camera lookfrom to plane of perfect focus.
...
private:
	...
	void initialize() {
		...
		auto viewport_upper_left{ camera_center - (w * focus_dist) - viewport_horizontal / 2 - viewport_vertical / 2 };
